    ...
    <main class="min-h-screen bg-gov-bg">
      ...
      <div class="bg-white border-b border-gray-200 py-8">
        <div class="max-w-7xl mx-auto px-6">
          <h1 class="text-3xl font-serif font-bold text-gov-dark mb-2">Prohibited Items</h1>
          <p class="text-gray-600">Items that cannot be imported or exported under Sri Lanka Customs Ordinance</p>
        </div>
      </div>

      <!-- Warning Banner -->
      <div class="bg-red-50 border-l-4 border-red-500 p-6 mx-6 my-8 rounded-lg max-w-7xl mx-auto">
        <h3 class="font-bold text-red-900 mb-2">⚠️ Important Notice</h3>
        <p class="text-sm text-red-800">
          Items listed below are completely prohibited from being imported or exported. Attempting to import prohibited goods may result in:
        </p>
      ...
      <div class="max-w-7xl mx-auto px-6 py-12">
        <div class="space-y-6">
          <div *ngFor="let category of prohibitedItems" class="bg-white rounded-lg shadow-gov border-l-4 border-red-500 p-6">
            <h2 class="text-xl font-bold text-gov-dark mb-2">{{ category.category }}</h2>
            <p *ngIf="category.description" class="text-gray-700 text-sm mb-4">{{ category.description }}</p>
            
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div *ngFor="let item of category.items" class="bg-red-50 border border-red-200 rounded p-4">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="bg-gov-light p-6 rounded-lg text-white">
              ...
              <p class="text-sm opacity-90">
                Table of Prohibitions and Restrictions Inwards and Outwards - Complete list of all prohibited items under Sri Lankan law
              </p>
            </div>
            <div class="bg-gov-primary p-6 rounded-lg text-white">
              <h4 class="font-bold mb-2">Contact for Clarification</h4>
              <p class="text-sm opacity-90">
                For specific items or clarification, contact the Customs ICT Directorate or your nearest Customs office
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="bg-amber-50 border border-amber-200 mx-6 my-12 rounded-lg p-6 max-w-7xl mx-auto">
        ...
        <p class="text-sm text-amber-800">
          If you're unsure whether an item is prohibited, contact your Customs House Agent (CHA) or the Sri Lanka Customs directly. It's better to check before attempting to import.
        </p>
      </div>
    </main>
