...
@Component({
  ...
  standalone: true,
  template: `
    <div class="relative bg-gradient-to-r from-gov-dark to-gov-primary overflow-hidden">
      <!-- Background Pattern -->
      ...
      <div class="relative max-w-7xl mx-auto px-6 py-20 text-center">
        ...
        <p class="text-xl text-gray-100 max-w-2xl mx-auto mb-8">
          Sri Lanka Customs' official resource for import/export tariff information, duty calculations, and regulatory requirements.
        </p>
        <div class="flex flex-wrap gap-4 justify-center">
          <button class="bg-gov-accent hover:bg-yellow-600 text-white px-8 py-3 rounded-lg font-semibold transition">
            Search Tariffs Now
          </button>
          <button class="bg-white hover:bg-gray-100 text-gov-dark px-8 py-3 rounded-lg font-semibold transition border-2 border-white">
            Browse by Chapter
          </button>
        </div>
      </div>
