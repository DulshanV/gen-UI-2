...
export const commodityCodes: CommodityCode[] = [
  ...
  },
  {
    ...
    notes:
      "Swine imports require specific approvals from Ministry of Livestock.",
  },
  {
    hsCode: "0103.91",
  ...
  },
  {
    ...
    notes:
      "Primate imports require CITES permits and approval from Department of Wildlife.",
  },
  {
    hsCode: "0106.12",
    description:
      "Other live animals - Mammals - Whales, dolphins, porpoises, manatees, dugongs, seals, sea lions, walruses",
    unit: "u",
    iclSls: "L",
    chapter: 1,
    section: "I",
    ...
    notes:
      "Protected marine mammals - strictly prohibited under CITES and international marine conservation agreements.",
  },
  {
    hsCode: "0106.31",
    ...
    notes:
      "Birds of prey require CITES permits and Department of Wildlife approval.",
  },
  {
    hsCode: "0106.32",
    description:
      "Other live animals - Birds - Psittaciformes (parrots, parakeets, macaws, cockatoos)",
    unit: "u",
    iclSls: "L",
    chapter: 1,
    section: "I",
    ...
    notes:
      "Parrot species require CITES permits and Department of Wildlife approval.",
  },
  {
    hsCode: "0106.41",
...
export function getCommodityByHSCode(
  hsCode: string,
): CommodityCode | undefined {
  return commodityCodes.find((item) => item.hsCode === hsCode);
}

export function getCommoditiesByChapter(
